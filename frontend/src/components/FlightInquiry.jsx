...
const FlightInquiry = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let message = `*Flight Inquiry - BM Hospitality*\n\n`;
    message += `✈️ *Flight Details:*\n`;
    message += `🛫 From: ${formData.from}\n`;
    message += `🛬 To: ${formData.to}\n`;
    message += `📅 Departure: ${formData.departureDate}\n`;
    ...
    message += `_Flight Booking Inquiry - BM Hospitality_`;
    
    sendWhatsAppMessage(message);
    toast.success('Flight inquiry sent! We will send you the best flight options on WhatsApp.');
        ...
        <Card className="max-w-4xl mx-auto shadow-xl">
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                Get Flight Options via WhatsApp
              </Button>
            </form>
          </CardContent>
        </Card>
